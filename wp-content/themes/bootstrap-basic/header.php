		            ...
		            <div id="navbar" class="go-right navbar-collapse collapse">
						...
						<?php
							...
							if (isset($_SESSION['email']) && isset($_SESSION['userid'])) {
								$session_lifetime = 1800; //session life is 30min
								if (time() - $_SESSION['lastvisit'] > $session_lifetime) {	//timeout
									...
									echo "
						           	<li class='dropdown'>
									<a href='#' class='dropdown-toggle' data-toggle='dropdown' role='button' aria-haspopup='true' aria-expanded='false'>". $_SESSION['email'] . "
									...
									<li><div class='user-menu-item'><small>USER ID:</small>" .$_SESSION['userid']." </div></li>
